...
SimpleForm.setup do |config|
  ...
  config.button_class = 'btn bg-primary'
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check mb-3', item_label_class: 'form-check-label', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
