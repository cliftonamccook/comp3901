...
class ProgrammesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programme" do
    assert_difference('Programme.count') do
      post programmes_url, params: { programme: { department_id: @programme.department_id, name: @programme.name } }
    end
  ...
  test "should update programme" do
    patch programme_url(@programme), params: { programme: { department_id: @programme.department_id, name: @programme.name } }
