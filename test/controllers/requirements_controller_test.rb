...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { minimum_amount_of_credits: @requirement.minimum_amount_of_credits, operation: @requirement.operation, requirement_group_id: @requirement.requirement_group_id } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { minimum_amount_of_credits: @requirement.minimum_amount_of_credits, operation: @requirement.operation, requirement_group_id: @requirement.requirement_group_id } }
