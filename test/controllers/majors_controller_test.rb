...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { name: @major.name, programme_id: @major.programme_id } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { name: @major.name, programme_id: @major.programme_id } }
