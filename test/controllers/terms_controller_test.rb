...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { end_year: @term.end_year, start_year: @term.start_year } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { end_year: @term.end_year, start_year: @term.start_year } }
